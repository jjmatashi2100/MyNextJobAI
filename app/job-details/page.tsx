...
import { Upload, Download, FileText, Briefcase, FileSpreadsheet, MessageSquare } from 'lucide-react'
          ...
          <CardContent className="p-4">
            <Tabs defaultValue="resume" className="w-full">
              ...
              <TabsContent value="resume">
                <Card className="shadow-lg">
                  <CardHeader className="bg-[#E6EAF5]">
                    ...
                    <CardDescription className="text-[#666666]">Tailor your resume to highlight relevant skills and experiences for this specific job opportunity</CardDescription>
                  </CardHeader>
                    ...
                    <div className="grid grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-sm text-[#666666]">
                          Describe how you'd like to modify your resume. Be specific about sections, skills, or experiences you want to highlight or change.
                        </p>
                        <Textarea 
              ...
              <TabsContent value="coverLetter">
                {/* Cover Letter content (similar structure to resume) */}
              </TabsContent>
              <TabsContent value="interview">
                {/* Interview Prep content (similar structure to resume) */}
              </TabsContent>
            </Tabs>
          </CardContent>
        </Card>
